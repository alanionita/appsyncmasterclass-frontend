...
<template>
  <main class="flex flex-col-reverse md:flex md:flex-row w-full h-screen" @keyup.esc="signUpStore.reset()">
    <section class="flex w-full md:w-1/2 bg-blue">
      <ul class="flex flex-col gap-4 list-none py-8 justify-center items-center w-full">
        <li class="flex items-center align-left w-10/12 md:w-1/2">
    ...
    <section class="flex flex-col w-full md:w-1/2 font-semibold gap-8 p-8">
      <form @submit.prevent="handleLogin" class="hidden md:flex w-full gap-8">
      ...
      <section class="w=1/2 md:mx-auto md:my-auto flex flex-col gap-4">
        <i class="fab fa-twitter text-blue text-4xl"></i>
        <p class="text-3xl">See what's happening in the world, right now!</p>
        <p>Join Twitter today.</p>
        <span class="flex flex-col gap-4 w-full md:w-1/2">
          <button @click.prevent="goTo('step1')"
            class="rounded-full bg-blue font-semibold text-lg text-white p-4 hover:bg-white hover:text-blue hover:border hover:border-blue">
            Sign up
          </button>
          <RouterLink to="/login">
            <button
  ...
  <section v-if="signUpStore.getStep !== ''" class="fixed w-full h-full top-0 left-0 flex items-center justify-center">
      ...
      <fieldset v-if="signUpStore.getStep === 'step1'">
        ...
        <div class="flex flex-col gap-4 px-8">
          ...
          <div class="w-full bg-lightblue border-b-2 border-dark mb-2 p-2">
            ...
            <input v-model="birthdate" id="birthdate" name="birthdate" class="w-full bg-lightblue text-lg" type="text">
            </input>
          </div>
        ...
        <div class="flex flex-col gap-4 px-8">
          ...
          <div>
            ...
            <div class="flex justify-between items-top mb-2 py-4">
              ...
              <input v-model="consentNotifications" id="notifications" name="consent" true-value="yes" false-value="no"
