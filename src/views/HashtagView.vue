    ...
    <template #middle>
      <section class="flex flex-col gap-4 py-4 overflow-y-auto">
        <div class="border-lighter flex items-center">
          ...
          <section class="lg:block ml-4 w-full">
            ...
            <input id="search-field"
              ...
              placeholder="Search Twitter" type="search" v-model="query" v-on:keyup.enter="searchSubmit" />
          </section>
        </div>
        <section class="grid grid-rows-1 grid-cols-5">
          ...
          <button class="col-span-1 row-span-1 text-dark font-bold border-b-2 md:px-5 md:py-4 hover:bg-lightblue">
            Photos
          </button>
          <button class="col-span-1 row-span-1 text-dark font-bold border-b-2 md:px-5 md:py-4 hover:bg-lightblue">
            Videos
